...
internal val previewCoin = Coin(
    id = "bitcoin".hashCode().toString(),
    rank = 1,
    name = "Bitcoin",
    symbol = "BTC",
    marketCapUsd = 1241273958896.75,
    priceUsd = 6500.52,
    changePercentage24Hr = 0.2
).toCoinUi()
...
// extension for Double that return our data class DisplayNumber
// Double to pretty String
fun Double.toDisplayableNumber():DisplayableNumber{
    // use default numberFormater
